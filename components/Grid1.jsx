        ...
        <div className="grid grid-cols-1 gap-8 sm:gap-10 lg:gap-14 lg:grid-cols-12 lg:items-center">
          ...
          <Parallax speed={0} className="lg:col-span-5">
            <div>
              ...
              <p className="mt-4 sm:mt-6 max-w-md text-xs sm:text-sm leading-6 sm:leading-7 text-slate-600 text-justify">
                We work closely with leading banks and financial institutions as a long-term technology partner, supporting mission-critical systems that demand stability, security, and regulatory alignment.
Our partnerships are built on trust, technical rigor, and shared accountability—with a clear focus on delivering reliable, scalable solutions that support operational continuity and long-term business objectives.
